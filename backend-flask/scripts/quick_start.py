...
def main():
    ...
    if not env_file.exists():
        if env_example.exists():
            ...
            print("\n⚠️  Please edit .env file to configure:")
    ...
    if db_path.exists():
        ...
        if response.lower() != 'y':
            ...
            if not run_command(
                ...
                print("\n⚠️  Data ingestion failed. Please run manually:")
                print(f"  cd {project_root}")
    ...
    if response.lower() != 'n':
        if not run_command(
            ...
            print("\n⚠️  Model setup failed. You can run it manually later:")
            print(f"  cd {project_root}")
    ...
    print("✅ NutriBot is ready to use!\n")
    print("Next steps:")
